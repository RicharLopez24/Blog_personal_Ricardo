...
export const DataProgramas = [
    ...
    },
    {
        ...
        p1: 'En esta programa se intento hacer la explicación de como funciona los numero flotantes de como la computadora los ve y que estandar usa para que los pueda leer',
        p2: 'En este programa se pide un numero flotante ya sea en binario o en la forma decimal como normalmente se ingres y se hacen las conversiones necesarias y luego nos da los resultados en forma del estandar y otra mas. Puedes acceder al codigo fuente dando clic en la imagen de la izquierda',
    ...
    },
    {
        ...
        p2: 'Para ello se tuvo que tomar la distancia entre ellos con la formula euclidiana y asi determinar a cual le pertenece cada punto.Puedes acceder al codigo fuente dando clic en la imagen de la izquierda ',
    },
